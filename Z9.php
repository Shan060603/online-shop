        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Sovereign</h1>
                    <hr>
                    <p>Introducing the Zenith: Sovereign, a sleek and opulent spacecraft within Zenith Aerospace's esteemed fleet. Draped in a black exterior adorned with refined gold and silver accents, it epitomizes cosmic elegance for the elite. This vessel boasts unmatched speed and range, paralleled only by its exceptional maneuverability, akin to the Zenith: Seeker. With superior sensors, tracking systems, and concealed weaponry, the Sovereign ensures precision, protection, and sophistication in every interstellar pursuit, setting a new standard in luxury and performance for discerning cosmic travelers.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 9; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Sovereign.jpg" alt="Zenith: Sovereign">
                </div>
            </div>
            <br>
        </section>
