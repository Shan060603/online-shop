        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Stargazer</h1>
                    <hr>
                    <p>Step into the cosmos with Zenith: Stargazer, the quintessential observatory spacecraft designed to unlock <br>
                       the secrets of distant star systems. This celestial marvel, crafted by Zenith Aerospace, transcends the <br>
                       boundaries of space exploration, offering an unparalleled vantage point for astronomers and adventurers <br>
                       alike. Stargazer's primary mission is to pierce the depths of the galaxy, mapping out interstellar routes <br>
                       with precision and opening pathways for long-distance voyages. With state-of-the-art observational instruments, <br>
                       this spacecraft transforms the inky canvas of space into a detailed tapestry of stars, allowing us to peer into <br>
                       the furthest corners of the cosmos. Zenith: Stargazer, where every journey is a celestial odyssey, and the mysteries <br>
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 7; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Stargazer.jpg" alt="Zenith: Stargazer">
                </div>
            </div>
            <br>
