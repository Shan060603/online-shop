        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Odyssey</h1>
                    <hr>
                    <p> Embark on a cosmic journey with Zenith: Odyssey, a spacecraft designed for the pure thrill of exploration. <br>
                        Featuring an expansive front cupola, this vessel offers unparalleled visibility, inviting you to witness the <br>
                        wonders of the universe in their unfiltered beauty. Crafted by Zenith Aerospace for passionate explorers, <br>
                        Zenith: Odyssey allows you to navigate within a solar system, with the potential for upgrades that extend <br>
                        your reach towards neighboring star systems. Experience the raw joy of discovery with Zenith: Odyssey, where <br>
                        each voyage becomes a personal odyssey into the vastness of space.
                    </p>
                    <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 2; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Odyssey.jpg" alt="Zenith: Odyssey">
                </div>
            </div>
            <br>
