        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Velocity</h1>
                    <hr>
                    <p> Introducing Zenith: Velocity, the pinnacle of speed and range in interstellar travel. <br>
                        Unrivaled in its class, this spacecraft stands as the fastest in Zenith's fleet, capable <br>
                        of reaching any planetary system within the galaxy at unparalleled speeds. Designed with <br>
                        a singular focus on interstellar travel, Zenith: Velocity boasts not only incredible <br>
                        velocity but also an extended range, making it the ultimate choice for those who crave <br>
                        the boundless freedom of exploring distant star systems. As the vanguard of speed, <br>
                        Zenith: Velocity propels you beyond the limits, transforming the galaxy into your cosmic playground.
                    </p>
                    <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 5; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Velocity.jpg" alt="Zenith: Velocity">
                </div>
            </div>
            <br>
