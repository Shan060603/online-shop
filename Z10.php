        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Quicksilver</h1>
                    <hr>
                    <p>Introducing the Zenith: Quicksilver, the epitome of luxury and speed crafted exclusively for the elite echelons of cosmic travelers. Inspired by the sleek design of a sports car, this spacecraft redefines opulence in space travel. Tailored for the most affluent clientele, the Quicksilver embodies elegance and speed, merging the allure of a high-performance vehicle with the sophistication of interstellar exploration. With its streamlined and aerodynamic silhouette, it stands as a testament to luxury and technological finesse, offering an unparalleled cosmic voyage that transcends conventional boundaries.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 10; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Quicksilver.jpg" alt="Zenith: Quicksilver">
                </div>
            </div>
            <br>
        </section>
