        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Prowler</h1>
                    <hr>
                    <p>Introducing the Zenith: Prowler, a solitary spacecraft engineered for superior stealth and agility within the cosmic domain. Like its counterpart, the Seeker, the Prowler offers a lone pilot enhanced concealed weaponry, exceptional maneuverability, and unmatched speed. Yet, its most striking attribute lies in its advanced stealth technology and state-of-the-art trackers, granting it the ability to elude the tracking mechanisms of most other spacecraft. With an innate capacity to remain hidden and navigate undetected, the Prowler excels in covert operations within the cosmic expanse, offering its pilot unprecedented control over anonymity and the element of surprise amidst the celestial arena.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 15; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Prowler.jpg" alt="Zenith: Prowler">
                </div>
            </div>
            <br>
        </section>
