        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Ivory</h1>
                    <hr>
                    <p>Introducing the Zenith: Ivory, an embodiment of celestial purity and unparalleled speed. Distinguished by its pristine white hue and meticulous engineering, Ivory radiates an aura of cosmic order and tranquility. Reserved for a lone pilot, this spacecraft conceals advanced weaponry akin to its counterparts, the Eclipse and Twilight, while surpassing them in speed. Seamlessly blending refined design with cutting-edge technology, Ivory offers its pilot not only absolute command over space but also unrivaled velocity within the cosmic expanse, transcending boundaries at a pace that outshines its peers, making celestial traversal an unparalleled experience.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 14; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Ivory.jpg" alt="Zenith: Ivory">
                </div>
            </div>
            <br>
        </section>
