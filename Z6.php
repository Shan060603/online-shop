        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: OrbitDome</h1>
                    <hr>
                    <p>Introducing Zenith: OrbitDome, a pioneering planetary orbital platform designed for <br>
                       extended exploration and habitation on distant worlds. Crafted by Zenith Aerospace, <br>
                       OrbitDome serves as a versatile base of operations, offering an orbital haven for <br>
                       long-term stays on planets across the cosmos. This innovative platform is equipped to <br>
                       accommodate a fleet of spacecraft, providing a hub for scientific research, planetary <br>
                       observation, and interstellar expeditions. With state-of-the-art facilities, OrbitDome <br>
                       transforms the challenges of distant planetary living into opportunities for discovery. <br>
                       Whether you're charting unexplored territories or establishing a foothold for future missions, <br>
                       Zenith: OrbitDome is your gateway to sustained exploration in the vast reaches of the cosmos.
                    </p>
                    <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 6; // Replace with the obtained productID from the webpage or set it to null if not available
                            ...
                            <form method="POST" action="#">
                                <input class="form-control numberOfProducts" type="number" min="0" max="100" name='numberOfProductsOrdered'>
                                <br>
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-OrbitDome.jpg" alt="Zenith: OrbitDome">
                </div>
            </div>
            <br>
        </section>
