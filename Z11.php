        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Voyager</h1>
                    <hr>
                    <p>Introducing the Zenith: Voyager, a cosmic marvel meticulously designed for luxurious and spacious deep-space exploration. This exceptional vessel stands as a testament to comfort and opulence, boasting the capacity to comfortably accommodate thousands of passengers on a lavish journey across the galaxy. With an emphasis on unparalleled comfort and sophistication, the Voyager redefines cosmic travel, offering a haven that transcends conventional boundaries. Lavish amenities, meticulously curated living spaces, and the utmost attention to detail ensure that each passenger experiences an indulgent lifestyle akin to premium accommodation, transforming their journey into a cosmically exquisite and unforgettable odyssey.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 11; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Voyager.jpg" alt="Zenith: Voyager">
                </div>
            </div>
            <br>
        </section>
