        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Seeker</h1>
                    <hr>
                    <p> Introducing Zenith: Seeker, the epitome of precision and speed in interstellar travel. Engineered for <br>
                        unparalleled maneuverability, this spacecraft boasts multiple thrust stabilizers that enable seamless <br>
                        execution of complex movements at incredible speeds. With the ability to maintain velocity without <br>
                        compromising control, Zenith: Seeker stands as a beacon of agility in the cosmos. Its advanced design <br>
                        not only prioritizes speed but also equips it with light weaponry, making it the spacecraft of choice <br>
                        for law enforcement across the galaxy. From high-speed pursuits to precision engagements, Zenith: Seeker <br>
                        ensures that justice travels at the speed of light.
                    </p>
                    <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 4; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Seeker.jpg" alt="Zenith: Seeker">
                </div>
            </div>
            <br>
