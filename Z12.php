        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Eclipse</h1>
                    <hr>
                    <p>Introducing the Zenith: Eclipse, a sleek and precision-crafted spacecraft tailored for the solitary voyager. Seating only one passenger, this spacecraft provides unparalleled command over the skies and space. With its seamless blend of sophistication and cutting-edge technology, the Eclipse offers its pilot exceptional maneuverability even at high speeds, redefining cosmic travel for those seeking absolute control and an exhilarating journey through the boundless expanse of the cosmos.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 12; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Eclipse.jpg" alt="Zenith: Eclipse">
                </div>
            </div>
            <br>
        </section>
