        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Stinger</h1>
                    <hr>
                    <p>Introducing the Zenith: Stinger, an agile marvel and the epitome of speed and maneuverability within Zenith's prestigious fleet. Uniquely crafted as the most lightweight spacecraft in the lineup, the Stinger harnesses its reduced weight to achieve incredible speeds and unmatched agility. Sacrificing heavy armaments in favor of swift velocity, this spacecraft carries only a minimal assortment of weapons, allowing it to soar unencumbered through the cosmic expanse.

Despite its light armament, the Stinger outpaces nearly any single-seater spacecraft, setting the benchmark for rapid interstellar travel. Its unparalleled speed and agile maneuvering capabilities ensure that it effortlessly outmaneuvers competitors, establishing the Stinger as the premier choice for cosmic pilots seeking unparalleled velocity and nimble navigation. The Zenith: Stinger, a testament to lightweight precision engineering, embodies the zenith of speed and agility, providing an exhilarating cosmic voyage for those who crave the thrill of unbridled velocity in the celestial realm.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 18; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Stinger.jpg" alt="Zenith: Stinger">
                </div>
            </div>
            <br>
        </section>
