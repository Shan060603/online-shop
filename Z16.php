        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Cyclops</h1>
                    <hr>
                    <p>Introducing the Zenith: Cyclops, a pioneering utility spacecraft meticulously designed for extensive deep space and planetary exploration. Sporting state-of-the-art tracking technology and advanced sensors, the Cyclops emerges as a beacon of cosmic discovery. Dominating its front facade is a colossal, powerful light and scanner, enabling the traversal of uncharted cosmic frontiers with unrivaled precision and thoroughness.

Primed for missions of exploration, the Cyclops accommodates a dedicated research crew, facilitating comprehensive investigations of distant celestial realms. Equipped with cutting-edge instrumentation and a suite of advanced sensors, this spacecraft stands at the forefront of cosmic exploration, unraveling the mysteries of the unknown with each daring expedition. The Zenith: Cyclops represents the zenith of scientific endeavor, heralding an era of unparalleled discovery and enlightenment amidst the unexplored reaches of the cosmos.</p>
                       <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 16; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Cyclops.jpg" alt="Zenith: Cyclops">
                </div>
            </div>
            <br>
        </section>
