        ...
        <section>
            <div class="hero-section">
                <div class="product-description">
                    <h1 class="product-title">Zenith: Starcruise</h1>
                    <hr>
                    <p>
                        Welcome aboard Zenith: Starcruise, the epitome of interstellar mass transport designed to <br>
                        redefine the way we traverse the cosmic highways. Crafted by Zenith Aerospace, Starcruise is <br>
                        not just a spacecraft; it's a vessel of collective exploration. With the capacity to carry <br>
                        hundreds of passengers, this interstellar cruiser invites you to embark on a journey to any <br>
                        destination within nearby star systems. Luxurious and efficient, Starcruise seamlessly blends <br>
                        cutting-edge technology with comfort, making every voyage a stellar experience. Whether you're <br>
                        a cosmic nomad or a seasoned explorer, Zenith: Starcruise is your ticket to traversing the vast <br>
                        distances of the galaxy in style and unparalleled convenience.
                    </p>
                    <?php
                       ...
                       <?php
                            ...
                            if (isset($_POST['order'])) {
                                ...
                                if (isset($_SESSION['userID'])) {
                                    ...
                                    $productID = 8; // Replace with the obtained productID from the webpage or set it to null if not available
                ...
                <div class="product-img">
                    <img class="product-img-size rounded-4" src="images/Zenith-Starcruise.jpg" alt="Zenith: Starcruise">
                </div>
            </div>
            <br>
